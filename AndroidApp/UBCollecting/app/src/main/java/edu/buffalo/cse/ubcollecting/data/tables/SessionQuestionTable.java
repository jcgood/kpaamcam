...
public class SessionQuestionTable extends Table<SessionQuestion>{
    ...
    public String createTable() {
        return "CREATE TABLE (" + KEY_ID + "TEXT PRIMARY KEY, " + KEY_SESSION_QUESTIONNAIRE_ID
                ...
                + KEY_VERSION + " NUMERIC NOT NULL DEFAULT 1.0 , " + KEY_NOTES + "TEXT, " + KEY_DATE + " TEXT, "
                + "FOREIGN KEY ( "+ KEY_SESSION_QUESTIONNAIRE_ID + ") " + "REFERENCES " + SessionQuestionnaireTable.TABLE
